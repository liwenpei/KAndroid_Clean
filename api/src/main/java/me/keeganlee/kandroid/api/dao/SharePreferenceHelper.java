...
public class SharePreferenceHelper {
    ...
    private static final String PREFERENCE_DEFAULT_NAME = "preference_default_name";

    public SharePreferenceHelper(Context context) {
        this(context, PREFERENCE_DEFAULT_NAME, Context.MODE_PRIVATE);
    }

    public SharePreferenceHelper(Context context, String preferenceName) {
        this(context, preferenceName, Context.MODE_PRIVATE);
    }

    @SuppressLint("CommitPrefEdits")
    public SharePreferenceHelper(Context context, String preferenceName, int mode) {
